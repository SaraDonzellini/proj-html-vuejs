      ...
      <div class="row flex">
        <div class="col-3">
          <div class="my_container">
            ...
            <h2>
              All our delectable pastries are backed fresh in our kitchen every morning, and are made with all-natural,
              all organic ingredients.
            </h2>
            <a class="btn mt-5 my_button" href="#">Start shopping</a>
          </div>
        </div>
        <div class="col-3">
          <div class="my_container">
